    ...
    <div class="card">
        ...
        <div class="col-lg-4">
            <div class="card mb-0 bg-soft-secondary">
                <img src="{{asset('asset/images/01.png')}}" class="img-fluid w-100" alt="">
            </div>
        </div>
        <div class="col-lg-8">
            <div class="d-flex align-items-top justify-content-between">
                <div class="music-detail">
                    <h3 class="mb-3">Eliana D’cruz Playlist</h3>
                    <p class="mb-3">Lorem Ipsum is simply dummy text of the printing and typesetting industry. <br>when an unknown printer took a galley of type and scrambled</p>
                    <div class="d-flex align-items-center mb-4">
                    <h6 class="mb-1 fw-bold me-3">Smith Jonas</h6>
                    <h6 class="ps-3 fw-bold me-3 border-start">15 Tracks</h6>
                    <h6 class="ps-3 fw-bold border-start">03:00 Duration</h6>
                </div>
                ...
                <div class="music-right">
                    ...
                    <div class="iq-circle me-2 share"><a href="javascript:void();"><svg class="text-primary" width="18" viewBox="0 0 24 24">
                    ...
                    <div class="iq-circle me-2"><a href="javascript:void();"><svg class="icon-20 text-primary" width="20" viewBox="0 0 24 24">
                    ...
                    <div class="iq-circle">
                        <a href="javascript:void();"><svg class="icon-20" width="20" viewBox="0 0 33 33" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <table class="table mb-0">
                ...
                <tbody>
                    <tr>
                        <td>01</td>
                        <td>
                            <div class="d-flex align-items-center col-10 col-md-5">
                                <div class="realese-song ">
                                    <a href="javascript:void(0);"><img src="{{asset('asset/images/05.png')}}" class="rounded avatar-60 img-fluid" alt=""></a>
                                </div>
                                <div class=" ms-3">
                                    <p class="mb-0">The Girl</p>
                                    <small>By Snoods Smith Jonas</small>
                                </div>
                            </div>
                        </td>
                        <td><p class="mb-0">Heart Is Beating</p> </td>
                        <td><p class="mb-0">4:21</p></td>
                        <td>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton07" style="">
                                    <a class="dropdown-item" href="#">
                                        <svg class="icon-20" width="20" height="33" viewBox="0 0 33 33" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M31.467 15.7853C31.4232 15.6865 30.3645 13.3378 28.0107 10.984C24.8745 7.84778 20.9132 6.19028 16.5532 6.19028C12.1932 6.19028 8.23196 7.84778 5.09571 10.984C2.74196 13.3378 1.67821 15.6903 1.63946 15.7853C1.5826 15.9132 1.55322 16.0516 1.55322 16.1915C1.55322 16.3315 1.5826 16.4699 1.63946 16.5978C1.68321 16.6965 2.74196 19.044 5.09571 21.3978C8.23196 24.5328 12.1932 26.1903 16.5532 26.1903C20.9132 26.1903 24.8745 24.5328 28.0107 21.3978C30.3645 19.044 31.4232 16.6965 31.467 16.5978C31.5238 16.4699 31.5532 16.3315 31.5532 16.1915C31.5532 16.0516 31.5238 15.9132 31.467 15.7853ZM16.5532 24.1903C12.7057 24.1903 9.34446 22.7915 6.56196 20.034C5.42027 18.8986 4.44895 17.604 3.67821 16.1903C4.44874 14.7765 5.42008 13.4817 6.56196 12.3465C9.34446 9.58903 12.7057 8.19028 16.5532 8.19028C20.4007 8.19028 23.762 9.58903 26.5445 12.3465C27.6884 13.4815 28.6618 14.7762 29.4345 16.1903C28.5332 17.8728 24.607 24.1903 16.5532 24.1903ZM16.5532 10.1903C15.3665 10.1903 14.2065 10.5422 13.2198 11.2015C12.2331 11.8607 11.4641 12.7978 11.0099 13.8942C10.5558 14.9905 10.437 16.1969 10.6685 17.3608C10.9 18.5247 11.4715 19.5938 12.3106 20.4329C13.1497 21.272 14.2188 21.8435 15.3827 22.075C16.5466 22.3065 17.753 22.1877 18.8493 21.7336C19.9457 21.2794 20.8827 20.5104 21.542 19.5237C22.2013 18.537 22.5532 17.377 22.5532 16.1903C22.5516 14.5995 21.9189 13.0743 20.794 11.9495C19.6692 10.8246 18.144 10.1919 16.5532 10.1903ZM16.5532 20.1903C15.7621 20.1903 14.9887 19.9557 14.3309 19.5162C13.6731 19.0766 13.1604 18.4519 12.8577 17.721C12.5549 16.9901 12.4757 16.1858 12.6301 15.4099C12.7844 14.634 13.1654 13.9213 13.7248 13.3618C14.2842 12.8024 14.9969 12.4215 15.7729 12.2671C16.5488 12.1128 17.353 12.192 18.0839 12.4948C18.8148 12.7975 19.4396 13.3102 19.8791 13.968C20.3186 14.6258 20.5532 15.3992 20.5532 16.1903C20.5532 17.2511 20.1318 18.2686 19.3816 19.0187C18.6315 19.7688 17.6141 20.1903 16.5532 20.1903Z" fill="currentColor"></path>
                                        </svg>
                                        View
                                    </a>
                                    <a class="dropdown-item" href="#">
                                    ...
                                    <a class="dropdown-item" href="#">
                                        <svg class="icon-20" width="20" viewBox="0 0 33 33" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M28.1562 19.1224V26.1224C28.1562 26.6528 27.9455 27.1615 27.5705 27.5366C27.1954 27.9116 26.6867 28.1224 26.1562 28.1224H6.15625C5.62582 28.1224 5.11711 27.9116 4.74204 27.5366C4.36696 27.1615 4.15625 26.6528 4.15625 26.1224V19.1224C4.15625 18.8571 4.26161 18.6028 4.44914 18.4153C4.63668 18.2277 4.89103 18.1224 5.15625 18.1224C5.42147 18.1224 5.67582 18.2277 5.86336 18.4153C6.05089 18.6028 6.15625 18.8571 6.15625 19.1224V26.1224H26.1562V19.1224C26.1562 18.8571 26.2616 18.6028 26.4491 18.4153C26.6367 18.2277 26.891 18.1224 27.1562 18.1224C27.4215 18.1224 27.6758 18.2277 27.8634 18.4153C28.0509 18.6028 28.1562 18.8571 28.1562 19.1224ZM15.4487 19.8299C15.5416 19.9228 15.6519 19.9966 15.7733 20.0469C15.8947 20.0972 16.0248 20.1231 16.1562 20.1231C16.2877 20.1231 16.4178 20.0972 16.5392 20.0469C16.6606 19.9966 16.7709 19.9228 16.8638 19.8299L21.8638 14.8299C21.9567 14.737 22.0304 14.6266 22.0806 14.5053C22.1309 14.3839 22.1568 14.2538 22.1568 14.1224C22.1568 13.991 22.1309 13.8609 22.0806 13.7395C22.0304 13.6181 21.9567 13.5078 21.8638 13.4149C21.7708 13.3219 21.6605 13.2482 21.5391 13.198C21.4178 13.1477 21.2876 13.1218 21.1562 13.1218C21.0249 13.1218 20.8947 13.1477 20.7734 13.198C20.652 13.2482 20.5417 13.3219 20.4487 13.4149L17.1562 16.7086V5.12236C17.1562 4.85714 17.0509 4.60279 16.8634 4.41525C16.6758 4.22772 16.4215 4.12236 16.1562 4.12236C15.891 4.12236 15.6367 4.22772 15.4491 4.41525C15.2616 4.60279 15.1562 4.85714 15.1562 5.12236V16.7086L11.8638 13.4149C11.6761 13.2272 11.4216 13.1218 11.1562 13.1218C10.8909 13.1218 10.6364 13.2272 10.4487 13.4149C10.2611 13.6025 10.1557 13.857 10.1557 14.1224C10.1557 14.3877 10.2611 14.6422 10.4487 14.8299L15.4487 19.8299Z" fill="currentColor"></path>
                                        </svg>
                                        Download
                                    </a>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex align-items-center col-10 col-md-5">
                                <div class="realese-song ">
                                    <a href="javascript:void(0);"><img src="{{asset('asset/images/06.png')}}" class="rounded avatar-60 img-fluid" alt=""></a>
                                </div>
                                <div class=" ms-3">
                                    <p class="mb-0">Infinity</p>
                                    <small>Edyta Gorniak</small>
                                </div>
                            </div>
                        </td>
                        <td><p class="mb-0">My Crying Eyes</p></td>
                        <td><p class="mb-0">3:21</p></td>
                        <td>
                            <div class="dropdown">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex align-items-center col-10 col-md-5">
                               <div class="realese-song ">
                                    <a href="javascript:void(0);"><img src="{{asset('asset/images/07.png')}}" class="rounded avatar-60 img-fluid" alt=""></a>
                                </div>
                                <div class=" ms-3">
                                    <p class="mb-0">Everything I Want</p>
                                    <small>Edyta Gorniak</small>
                                </div>
                            </div>
                        </td>
                        <td><p class="mb-0"> My Lovely Dad</p></td>
                        <td><p class="mb-0">02:21</p></td>
                        <td>
                            <div class="dropdown">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex align-items-center col-10 col-md-5">
                                <div class="realese-song ">
                                    <a href="javascript:void(0);"><img src="{{asset('asset/images/08.png')}}" class="rounded avatar-60 img-fluid" alt=""></a>
                                </div>
                                <div class=" ms-3">
                                    <p class="mb-0">The Silent One</p>
                                    <small>Edyta Gorniak</small>
                                </div>
                            </div>
                        </td>
                        <td><p class="mb-0">Travel Mix</p> </td>
                        <td><p class="mb-0">3:21</p> </td>
                        <td>
                            <div class="dropdown">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex align-items-center col-10 col-md-5">
                               <div class="realese-song ">
                                    <a href="javascript:void(0);"><img src="{{asset('asset/images/10.png')}}" class="rounded avatar-60 img-fluid" alt=""></a>
                                </div>
                                <div class=" ms-3">
                                    <p class="mb-0">Just Perfect</p>
                                    <small>By Nil Ana Meet Nagak</small>
                                </div>
                            </div>
                        </td>
                        <td><p class="mb-0">Way Of Right</p></td>
                        <td><p class="mb-0">4:21</p></td>
                        <td>
                            <div class="dropdown">
                                <span class="d-flex align-items-center h5 mb-0" id="dropdownMenuButton10" role="button" data-bs-toggle="dropdown" aria-expanded="false">
